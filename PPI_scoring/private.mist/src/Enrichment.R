...
Enrichment.main = function(data_file, output_dir, prey_colname, grouped=T, enrichment_p_cutoff=enrichment_p_cutoff, id_type="UNIPROT"){
  ...
  res = list(GO_CC_groups=GO_CC_groups, GO_BP_groups=GO_BP_groups, GO_MF_groups=GO_MF_groups, KEGG_groups=KEGG_groups)  # removed PFAM because there seems to be an issue with the PFAM.db
